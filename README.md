...
- 🔗 [View Project](https://example.com/freshdesk-project)  

---

### 🛡️ **Suricata Network Intrusion Detection**  
- **Overview**: Configured and deployed Suricata to monitor and analyze network traffic for potential security threats.  
- **Skills Used**: Scanning, Network security hardening, Vulnerability management.   
- 🔗 [View Project](https://example.com/suricata-project)  

---

### 📊 **Evebox Alert Management**  
- **Overview**: Leveraged Evebox to manage and analyze alerts generated by Suricata, enhancing incident response capabilities.  
- **Skills Used**: Alert triage, Event analysis, Reporting.  
- 🔗 [View Project](https://example.com/evebox-project)  
